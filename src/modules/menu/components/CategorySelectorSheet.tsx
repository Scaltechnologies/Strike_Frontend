// src/modules/menu/components/CategorySelectorSheet.tsx
// Polished bottom sheet for choosing an item's category — opened from the
// "Change" link in the Add/Edit Item form. Replaces the old inline grid
// that was re-implemented per-screen; this is the one shared selector.
// Selecting a category closes the sheet immediately (no confirm step).

import { useState, useMemo, useRef, useEffect } from 'react';
import {
  View, TouchableOpacity, Image, StyleSheet, Modal, FlatList, Animated,
} from 'react-native';
...
// Search only earns its place once scanning the list gets slower than typing.
...
export default function CategorySelectorSheet({ visible, categories, selectedId, onSelect, onClose }: Props) {
...
const styles = StyleSheet.create({
  ...
  thumb: { width: 44, height: 44, borderRadius: 22, backgroundColor: DS.surface },
  thumbPlaceholder: { alignItems: 'center', justifyContent: 'center' },
  thumbInitial: { fontSize: 15, fontWeight: '800', color: DS.primary },
